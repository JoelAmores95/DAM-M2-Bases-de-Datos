...
CREATE TABLE IF NOT EXISTS empresa.DEPT (
 DEPT_NO  TINYINT (2) UNSIGNED COMMENT 'Número del departament',
 DNOM     VARCHAR(14) NOT NULL UNIQUE COMMENT 'Nom del departament',
 LOC      VARCHAR(14) COMMENT 'Localitat del departament',
 PRIMARY KEY (DEPT_NO) ) ;
...
CREATE TABLE IF NOT EXISTS empresa.EMP (
 EMP_NO    SMALLINT (4) UNSIGNED COMMENT 'Número empleat',
 COGNOM    VARCHAR (10) NOT NULL COMMENT 'Cognom empleat',
 OFICI     VARCHAR (10) COMMENT 'Ofici empleat',
 CAP       SMALLINT (4) UNSIGNED COMMENT 'Número empleat que és el cap directe (taula EMP)',
 DATA_ALTA DATE COMMENT 'Data alta',
 SALARI    INT UNSIGNED COMMENT 'Salari mensual',
 COMISSIO  INT UNSIGNED COMMENT 'Import de les comisions',
 DEPT_NO   TINYINT (2) UNSIGNED NOT NULL COMMENT 'Departament al que pertany (taula DEPT)',
 PRIMARY KEY (EMP_NO),
...
CREATE TABLE IF NOT EXISTS empresa.CLIENT (
 CLIENT_COD          INT(6) UNSIGNED PRIMARY KEY COMMENT 'Codi del client',
 NOM                 VARCHAR (45) NOT NULL COMMENT 'Nom del client',
 ADRECA              VARCHAR (40) NOT NULL COMMENT 'Adreça del client',
 CIUTAT              VARCHAR (30) NOT NULL COMMENT 'Ciutat del client',
 ESTAT               VARCHAR (2) COMMENT 'País del client',
 CODI_POSTAL         VARCHAR (9) NOT NULL COMMENT 'Codi postal del client',
 AREA                SMALLINT(3) COMMENT 'Àrea telefònica',
 TELEFON             VARCHAR (9) COMMENT 'Telèfon del client',
 REPR_COD            SMALLINT(4) UNSIGNED COMMENT 'Codi del representnat del client. És un dels empleats (taula EMP)',
 LIMIT_CREDIT        DECIMAL(9,2) UNSIGNED COMMENT 'Límit de crèdit de què disposa el client',
 OBSERVACIONS        TEXT COMMENT 'Observacions',
...
CREATE TABLE IF NOT EXISTS empresa.PRODUCTE (
 PROD_NUM     INT (6) UNSIGNED PRIMARY KEY COMMENT 'Codi del producte',
 DESCRIPCIO   VARCHAR (30) NOT NULL  UNIQUE COMMENT 'Descripció del producte');
...
CREATE TABLE IF NOT EXISTS empresa.COMANDA  (
 COM_NUM             SMALLINT(4) UNSIGNED PRIMARY KEY COMMENT 'Número ordre de venda',
 COM_DATA            DATE COMMENT 'Data ordre de venda',
 COM_TIPUS           CHAR (1) COMMENT 'Tipus ordre. Valors vàlids: A, B, C' CHECK (COM_TIPUS IN ('A','B','C')) ,
 CLIENT_COD          INT (6) UNSIGNED NOT NULL COMMENT 'Codi del client que efectua ordre (taula CLIENT)',
 DATA_TRAMESA        DATE COMMENT 'Data enviament ordre',
 TOTAL               DECIMAL(8,2) UNSIGNED COMMENT 'Import total ordre',
...
CREATE TABLE IF NOT EXISTS empresa.DETALL  (
 COM_NUM             SMALLINT(4) UNSIGNED COMMENT 'Número ordre (taula COMANDA)',
 DETALL_NUM          SMALLINT(4) UNSIGNED COMMENT 'Número de línia per cada ordre',
 PROD_NUM            INT(6) UNSIGNED NOT NULL COMMENT 'Codi del producte de la línia (taula PRODUCTE)',
 PREU_VENDA          DECIMAL(8,2) UNSIGNED COMMENT 'Preu venda producte',
 QUANTITAT           INT (8) COMMENT 'Quantitat de producte a vendre',
 IMPORT              DECIMAL(8,2) COMMENT 'Import total de la línia',
